...
use Ziki\MusicBundle\Form\ArtistType;
...
class ArtistController extends Controller
{
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ZikiMusicBundle:Artist')->find($id);
     ...
     * @Method("POST")
     * @Template("ZikiMusicBundle:Artist:new.html.twig")
     */
     ...
     * @Method("POST")
     * @Template("ZikiMusicBundle:Artist:edit.html.twig")
     */
